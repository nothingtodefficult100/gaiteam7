                            ...
                            <div class="cart">
                                <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                    ...
                                    <div class="cart_content">
                                        ...
                                        @else
                                        <div class="cart_price"><span style="font-size: 20px;font-weight:bold;color:black"> ৳ </span> {{ Cart::Subtotal() }}</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="" target="_blank">Web Development Project-Team7</a>
</div>
